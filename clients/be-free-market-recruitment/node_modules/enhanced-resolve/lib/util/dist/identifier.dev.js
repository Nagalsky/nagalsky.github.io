...
function parseIdentifier(identifier) {
  ...
  var firstEscape = identifier.indexOf("\0");

  if (firstEscape < 0) {
    // Fast path for inputs that don't use \0 escaping.
    var queryStart = identifier.indexOf("?"); // Start at index 1 to ignore a possible leading hash.

    var fragmentStart = identifier.indexOf("#", 1);
  ...
  var match = PATH_QUERY_FRAGMENT_REGEXP.exec(identifier);
