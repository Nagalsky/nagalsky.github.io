...
var mkdirp_native_js_1 = require("./mkdirp-native.js");

var opts_arg_js_1 = require("./opts-arg.js");

var path_arg_js_1 = require("./path-arg.js");

var use_native_js_1 = require("./use-native.js");
/* c8 ignore start */
...
var mkdirpSync = function mkdirpSync(path, opts) {
  ...
  var resolved = (0, opts_arg_js_1.optsArg)(opts);
...
exports.mkdirp = Object.assign(function _callee(path, opts) {
  var resolved;
  return regeneratorRuntime.async(function _callee$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          path = (0, path_arg_js_1.pathArg)(path);
          resolved = (0, opts_arg_js_1.optsArg)(opts);
          return _context.abrupt("return", (0, use_native_js_1.useNative)(resolved) ? (0, mkdirp_native_js_1.mkdirpNative)(path, resolved) : (0, mkdirp_manual_js_1.mkdirpManual)(path, resolved));
