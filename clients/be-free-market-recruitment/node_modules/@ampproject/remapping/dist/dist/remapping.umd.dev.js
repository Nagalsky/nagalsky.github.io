  ...
  function build(map, loader, importer, importerDepth) {
    ...
    var children = resolvedSources.map(function (sourceFile, i) {
      ...
      var source = ctx.source,
          content = ctx.content,
          ignore = ctx.ignore; // If there is a sourcemap, then we need to recurse into it to load its source files.

      if (sourceMap) return build(new traceMapping.TraceMap(sourceMap, source), loader, source, depth); // Else, it's an unmodified source file.
