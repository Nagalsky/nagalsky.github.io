  ...
  _createClass(Node, [{
    ...
    value: function positionBy() {
      ...
      if (opts.index) {
        ...
        var inputString = 'document' in this.source.input ? this.source.input.document : this.source.input.css;
        var stringRepresentation = inputString.slice(sourceOffset(inputString, this.source.start), sourceOffset(inputString, this.source.end));
    ...
    value: function positionInside(index) {
      ...
      var inputString = 'document' in this.source.input ? this.source.input.document : this.source.input.css;
      var offset = sourceOffset(inputString, this.source.start);
    ...
    value: function rangeBy() {
      ...
      var end = this.source.end ? {
        ...
        offset: typeof this.source.end.offset === 'number' ? // `source.end.offset` is exclusive, so we don't need to add 1
        this.source.end.offset : // Since line/column in this.source.end is inclusive,
    ...
    key: "warn",
    value: function warn(result, text) {
