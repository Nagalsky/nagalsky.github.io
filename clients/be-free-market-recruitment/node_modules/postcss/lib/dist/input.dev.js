...
function () {
  ...
  _createClass(Input, [{
    ...
    value: function error(message, line, column) {
      ...
      var endColumn, endLine, endOffset, offset, result;
      ...
      if (line && _typeof(line) === 'object') {
        ...
        if (typeof start.offset === 'number') {
          offset = start.offset;
          var pos = this.fromOffset(offset);
          line = pos.line;
          column = pos.col;
        } else {
          line = start.line;
        ...
        if (typeof end.offset === 'number') {
          ...
          var _pos = this.fromOffset(endOffset);
        ...
        var _pos2 = this.fromOffset(offset);
    ...
    key: "fromLineAndColumn",
    value: function fromLineAndColumn(line, column) {
      var lineToIndex = getLineToIndex(this);
      var index = lineToIndex[line - 1];
    ...
    value: function fromOffset(offset) {
      var lineToIndex = getLineToIndex(this);
      var lastLine = lineToIndex[lineToIndex.length - 1];
      var min = 0;
