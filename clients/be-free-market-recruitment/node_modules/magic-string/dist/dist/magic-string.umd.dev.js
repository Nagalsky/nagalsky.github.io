...
(function (global, factory) {
  (typeof exports === "undefined" ? "undefined" : _typeof(exports)) === 'object' && typeof module !== 'undefined' ? module.exports = factory() : typeof define === 'function' && define.amd ? define(factory) : (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.MagicString = factory());
})(void 0, function () {
  'use strict';
  ...
  function encode(decoded) {
    ...
    for (var _i2 = 0; _i2 < decoded.length; _i2++) {
      ...
      if (_i2 > 0) writer.write(semicolon);
  ...
  function getLocator(source) {
    ...
    for (var _i4 = 0, pos = 0; _i4 < originalLines.length; _i4++) {
      lineOffsets.push(pos);
      pos += originalLines[_i4].length + 1;
    }
    ...
    _createClass(Mappings, [{
      ...
      value: function addEdit(sourceIndex, content, loc, nameIndex) {
        if (content.length) {
          ...
          var previousContentLineEnd = -1; // Loop through each line in the content and add a segment, but stop if the last line is empty,
      ...
      value: function addUneditedChunk(sourceIndex, chunk, original, loc, sourcemapLocations) {
        ...
        var first = true; // when iterating each char, check if it's in a word boundary
      ...
      value: function advance(str) {
        ...
        if (lines.length > 1) {
          for (var _i5 = 0; _i5 < lines.length - 1; _i5++) {
  ...
  function () {
    ...
    _createClass(MagicString, [{
      ...
      value: function indent(indentStr, options) {
        ...
        if (options.exclude) {
          ...
          exclusions.forEach(function (exclusion) {
            for (var _i6 = exclusion[0]; _i6 < exclusion[1]; _i6 += 1) {
              isExcluded[_i6] = true;
            }
          });
        }
      ...
      value: function overwrite(start, end, content, options) {
        options = options || {};
        return this.update(start, end, content, _objectSpread({}, options, {
      ...
      value: function _replaceRegexp(searchValue, replacement) {
        ...
        if (searchValue.global) {
          ...
          matches.forEach(function (match) {
            if (match.index != null) {
              var _replacement = getReplacement(match, _this2.original);

              if (_replacement !== match[0]) {
                _this2.overwrite(match.index, match.index + match[0].length, _replacement);
              }
            }
          });
        } else {
          ...
          if (match && match.index != null) {
            var _replacement2 = getReplacement(match, this.original);

            if (_replacement2 !== match[0]) {
              this.overwrite(match.index, match.index + match[0].length, _replacement2);
            }
          }
        }
      ...
      value: function _replaceAllString(string, replacement) {
        ...
        for (var index = original.indexOf(string); index !== -1; index = original.indexOf(string, index + stringLength)) {
          var previous = original.slice(index, index + stringLength);
