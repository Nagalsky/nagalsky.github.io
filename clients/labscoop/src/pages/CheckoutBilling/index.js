  ...
  return (
    <Fragment>
      <Wizard>
        ...
        <WizardItem isActive>Billing</WizardItem>
          ...
          <Box flex="1" mb={[2, 2, 2, 0]} py={[2, 2, 4]} px={[1, 1, 1, 5]}>
            <Box display="flex" flexDirection={['column', 'column', 'row']}>
              ...
              <Box flex="1">
                ...
                >
                  ...
                  >
                    ...
                    >
                      ...
                      <Text fontSize={['12px', '14px']}>Checkout Billing</Text>
                    </Box>
                  </Box>
                ...
                <Checkbox
                  title="Same as Primary Shipping Address"
                  id="checkbox-2"
                  mb={1}
                />

                <Field type="text" title="Full Name" id="field-full-name" />
                <Field
                  type="text"
                  title="Company / Institutuon"
                  id="field-company"
                />
                <Field
                  type="text"
                ...
                <Checkbox
                  title="Make this your primary shipping address."
                  id="checkbox-1"
                />
              </Box>
            </Box>
