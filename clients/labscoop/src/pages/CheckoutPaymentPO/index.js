              ...
              <Box flex="1">
                ...
                >
                  ...
                  >
                    ...
                    >
                      ...
                      <Text fontSize={['12px', '14px']}>Payment PO</Text>
                    </Box>
                  </Box>
                ...
                <Box width={['100%', '100%', '100%', '75%', '50%']}>
                  <StyledBusinessBox>
                    <Box mr="auto">
                      <StyledBusinessLink href="/">
                        <Icon size="32px" icon="file-invoice" mr="10px" />
                        <Box flex="1">
                          Purchase Order 3r3098r398.pdf{' '}
...
export default CheckoutPaymentPO
