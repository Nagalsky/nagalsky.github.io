...
const CheckoutPaymentDirectWire = () => {
          ...
          <Box flex="1" mb={[2, 2, 2, 0]} py={[2, 2, 4]} px={[1, 1, 1, 5]}>
            <Box display="flex" flexDirection={['column', 'column', 'row']}>
              ...
              >
                <Box mb={2}>
                  <TrayPopup
                    toggleTitle="Add Purchase Order"
              ...
              <Box flex="1">
                ...
                >
                  ...
                  >
                    ...
                    >
                      ...
                      <Text fontSize={['12px', '14px']}>Direct wire</Text>
                    </Box>
                  </Box>
                ...
                <Box width={['100%', '100%', '100%', '75%', '50%']}>
                  ...
                  >
                    <Box mr="auto">
                      <StyledBusinessLink href="/">
                        <Icon size="32px" icon="credit-card" mr="10px" />
                        <Box flex="1">
                          Wire Transfer Confirmation WT25641.pd
                          <Box display="block" color="black">
                            Bank WIre Transfer Confirmation
                          </Box>
                        </Box>
                      </StyledBusinessLink>
                    </Box>
...
export default CheckoutPaymentDirectWire
