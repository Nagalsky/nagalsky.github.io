              ...
              <Box mb={[1, 1, 1, 1, 0]} display="flex" alignItems="center">
                ...
                >
                  ...
                  <Text fontSize={['12px', '14px']}>
                    <b>Shared Cart</b> Timberland Lab
                  </Text>
                </Box>
              </Box>
                  ...
                  >
                    ...
                    >
                      ...
                      <BtnLink
                        ...
                        justifyContent={['flex-start', 'flex-end']}
                      >
                        Save for Later <Icon icon="trash" ml="10px" />
                      </BtnLink>
                    </Box>
                  </Box>
                </Box>
                ...
                <Box mt={1} display={['none', 'flex']} alignItems="center">
                  ...
                  {product.productApproved && (
                    <Box
                      flexShrink="0"
                      ml="2"
                      width={['148px', '148px', '148px', '130px', '130px']}
                    >
                      <Status title="Approved" variant="success" />
                    </Box>
                  )}
                </Box>
                  ...
                  <Box mt={1} display={['none', 'flex']} alignItems="center">
                    ...
                    {product.productPending && (
                      <Box
                        ...
                        width={['148px', '148px', '148px', '130px', '130px']}
                      >
                        <Status title="Pending" variant="warning" />
                      </Box>
                    )}
                  </Box>
