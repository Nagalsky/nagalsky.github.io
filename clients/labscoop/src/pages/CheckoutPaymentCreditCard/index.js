...
const CheckoutPaymentCreditCard = () => {
                ...
                >
                  ...
                  >
                    ...
                    >
                      ...
                      <Text fontSize={['12px', '14px']}>Credit card</Text>
                    </Box>
                  </Box>
                ...
                <Panel>
                  ...
                  >
                    <Box
                      ...
                      mb={[1, 1, 1, 0, 0]}
                    >
                      <Image src={discover} alt="alt" width="100%" />
                    </Box>
                    <Box mr={[2, 2, 2, 5, 5]} mb={[1, 1, 0, 0, 0]}>
                      <Text mb={0}>Visa ending in 8493</Text>
                      <Text fontSize="10px">
