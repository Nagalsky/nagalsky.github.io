...
function proVideos() {
  return src(options.paths.src.video + "/**/*").pipe(
    dest(options.paths.build.video)
  );
}
...
exports.default = series(
  ...
  parallel(devStyles, devScripts, devImages, devHTML, devVideos), //Run All tasks in parallel
...
exports.prod = series(
  ...
  parallel(prodStyles, prodScripts, prodImages, prodHTML, proVideos), //Run All tasks in parallel
  buildFinish
);
